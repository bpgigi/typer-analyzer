...
| 姓名 | 学号 | GitHub | 负责模块 |
|------|------|--------|----------|
| 李子昂 | 20232241100 | bpgigi | 项目架构、主程序、文档 |
| 杨孝涛 | 20232241261 | lihuabaiaq | 数据采集、GitHub API |
| 张玉龙 | 20232241226 | Zyl3110568387 | 可视化图表 |
| 郭楷源 | 20232241222 | 194962887gky | AST/LibCST 分析 |
| 王弘宇 | 20232241031 | severus-hbp | PySnooper/Z3 分析、测试 |
